...
if (have_posts()) {
  ...
  $front_page_content = apply_filters('the_content', $front_page_content);
  rewind_posts();
} else {
  $front_page_content = '';
}
...
<?php if (! empty(trim(wp_strip_all_tags($front_page_content)))) : ?>
<section class="front-page-editor" aria-label="Contenu éditable de la page d'accueil">
  <div class="wrap wrap--text">
    <div class="front-page-editor__inner">
