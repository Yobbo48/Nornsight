...
import runeReadingApiPlugin from './plugins/vite-plugin-rune-reading-api.js';
...
export default defineConfig({
	...
	customLogger: logger,
	plugins: [
		...(isDev ? [inlineEditPlugin(), editModeDevPlugin(), selectionModePlugin(), iframeRouteRestorationPlugin(), pocketbaseAuthPlugin(), runeReadingApiPlugin()] : []),
		react(),
