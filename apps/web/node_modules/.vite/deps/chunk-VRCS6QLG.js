import {
  ...
  propagation,
  trace
} from "./chunk-2KJD6SDV.js";

// ../../node_modules/@langfuse/core/dist/index.mjs
init_esm();
...
var _a;
var _LoggerSingleton = class _LoggerSingleton2 {
  /**
   ...
   */
  static getInstance() {
    if (!_LoggerSingleton2.instance) {
      _LoggerSingleton2.instance = new Logger(_LoggerSingleton2.defaultConfig);
    }
    return _LoggerSingleton2.instance;
  }
  /**
  ...
  static configure(config) {
    _LoggerSingleton2.defaultConfig = config;
    _LoggerSingleton2.instance = new Logger(config);
  }
  /**
   ...
   */
  static reset() {
    _LoggerSingleton2.instance = null;
    _LoggerSingleton2.defaultConfig = {
      level: 1
      /* INFO */
    };
  }
...
_LoggerSingleton.defaultConfig = {
  level: (_a = parseLogLevelFromEnv()) != null ? _a : 1
  /* INFO */
};
...
var LangfuseOtelSpanAttributes = ((LangfuseOtelSpanAttributes2) => {
...
function propagateAttributes(params, fn) {
  ...
  if (userId) {
    if (isValidPropagatedString({ value: userId, attributeName: "userId" })) {
      context2 = setPropagatedAttribute({
        key: "userId",
        value: userId,
        context: context2,
        span,
  ...
  return context.with(context2, fn);
}
function getPropagatedAttributesFromContext(context2) {
...
function setPropagatedAttribute(params) {
  ...
  let context2 = params.context;
  let mergedMetadata = key === "metadata" ? getContextMergedMetadata(context2, value) : {};
  let mergedTags = key === "tags" ? getContextMergedTags(context2, value) : [];
  const contextKey = getContextKeyForPropagatedKey(key);
  if (key === "metadata") {
    context2 = context2.setValue(contextKey, mergedMetadata);
  } else if (key === "tags") {
    context2 = context2.setValue(contextKey, mergedTags);
  } else {
    context2 = context2.setValue(contextKey, value);
  }
...
function getContextMergedTags(context2, newTags) {
  const existingTags = context2.getValue(LangfuseOtelContextKeys["tags"]);
...
function getContextMergedMetadata(context2, newMetadata) {
  const existingMetadata = context2.getValue(
...
function getSpanKeyForPropagatedKey(key) {
  switch (key) {
    ...
    case "sessionId":
      return "session.id";
    case "version":
      return "langfuse.version";
    case "traceName":
      return "langfuse.trace.name";
    case "metadata":
      return "langfuse.trace.metadata";
    case "tags":
      return "langfuse.trace.tags";
    case "experimentId":
      return "langfuse.experiment.id";
    case "experimentName":
      return "langfuse.experiment.name";
    case "experimentMetadata":
      return "langfuse.experiment.metadata";
    case "experimentDatasetId":
      return "langfuse.experiment.dataset.id";
    case "experimentItemId":
      return "langfuse.experiment.item.id";
    case "experimentItemMetadata":
      return "langfuse.experiment.item.metadata";
    case "experimentItemRootObservationId":
      return "langfuse.experiment.item.root_observation_id";
    default: {
      const fallback = key;
...
function getSpanKeyFromBaggageKey(baggageKey) {
  ...
  if (suffix.startsWith("metadata_")) {
    ...
    return `${"langfuse.trace.metadata"}.${metadataKey}`;
  }
  switch (suffix) {
    case "user_id":
...
//# sourceMappingURL=chunk-VRCS6QLG.js.map
