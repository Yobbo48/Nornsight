...
// ../../node_modules/@langfuse/client/dist/index.mjs
init_esm();
...
var ChatMessageType = ((ChatMessageType2) => {
...
var TextPromptClient = class extends BasePromptClient {
  ...
  compile(variables, _placeholders) {
    return mustache_default.render(this.promptResponse.prompt, variables != null ? variables : {});
  }
  /**
...
var ChatPromptClient = class _ChatPromptClient extends BasePromptClient {
  ...
  compile(variables, placeholders) {
    ...
    for (const item of this.prompt) {
      ...
      } else if ("role" in item && "content" in item && item.type === "chatmessage") {
        messagesWithPlaceholdersReplaced.push({
          role: item.role,
    ...
    return messagesWithPlaceholdersReplaced.map((item) => {
      if (typeof item === "object" && item !== null && "role" in item && "content" in item && typeof item.content === "string") {
        return {
          ...item,
          content: mustache_default.render(item.content, variables != null ? variables : {})
        };
      } else {
        return item;
      }
...
var LangfuseClient = class {
  ...
  constructor(params) {
    ...
    this.baseUrl = (_e = (_d = (_c = params == null ? void 0 : params.baseUrl) != null ? _c : getEnv("LANGFUSE_BASE_URL")) != null ? _d : getEnv("LANGFUSE_BASEURL")) != null ? _e : (
      // legacy v2
    ...
    const timeoutSeconds = (_g = params == null ? void 0 : params.timeout) != null ? _g : Number((_f = getEnv("LANGFUSE_TIMEOUT")) != null ? _f : 5);
...
//# sourceMappingURL=@langfuse_client.js.map
