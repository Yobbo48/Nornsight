...
// ../../node_modules/@langfuse/tracing/dist/index.mjs
init_esm();
init_esm();
...
var LANGFUSE_GLOBAL_SYMBOL = /* @__PURE__ */ Symbol.for("langfuse");
...
function updateActiveObservation(attributes, options) {
  ...
  if (!(options == null ? void 0 : options.asType)) {
    otelAttributes[LangfuseOtelSpanAttributes.OBSERVATION_TYPE] = void 0;
  }
...
function getActiveTraceId() {
  var _a;
  return (_a = trace.getActiveSpan()) == null ? void 0 : _a.spanContext().traceId;
}
function getActiveSpanId() {
  var _a;
  return (_a = trace.getActiveSpan()) == null ? void 0 : _a.spanContext().spanId;
}
...
//# sourceMappingURL=chunk-ZIFE3UP5.js.map
